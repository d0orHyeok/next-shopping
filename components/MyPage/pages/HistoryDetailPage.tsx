...
import RefundModal from '../section/RefundModal'
...
const HistoryDetailPage = ({ payment }: IHistoryDetailPageProps) => {
  const [openRefundMoal, setOpenRefundMoal] = useState(false)
  ...
  return (
    <>
      <div className={cx('wrapper')}>
        ...
        <section>
          ...
          <TableContainer sx={{ marginBottom: '3rem' }}>
                    ...
                    <TableRow key={`${product.name}${orderIndex}`}>
                      ...
                      >
                        ...
                        <div className={cx('mediaCell')}>
                          ...
                          <div className={cx('refundState-flex')}>
                            {refundState}
                          </div>
                        </div>
                      </TableCell>
            ...
            {payment.orders.find((order) => order.refund_state === null) && (
              <div className={cx('refundControls')}>
                <button className={cx('refundBtn')} onClick={handleClickRefund}>
                  전체환불
                </button>
              </div>
            )}
        ...
        <section className={cx('section', 'section-desc')}>
          ...
          <div className={cx('desc-item')}>
            ...
            <div className={cx('desc-item-content')}>
              <ul>
                <li>
      ...
      <RefundModal
        payment={payment}
        open={openRefundMoal}
        onClose={() => setOpenRefundMoal(false)}
      />
    </>
  )
}
